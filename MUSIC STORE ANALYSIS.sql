BUSINESS PROBLEMS
-- Q1:- Who is the senior most employee bassed on job title ?
...
-- Q9:- We want to find out the most popular music Genre for each country. We determine the most popular genre as the genre with the highest amount of purchases. Write a query that returns each country along with the top Genre. For countries where with the highest amount of purchases.For countries where the maximum number of purchases is shared return all Genres ?
